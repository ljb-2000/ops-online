...
DATABASES = {
    'default': {
        ...
        'NAME': 'tclsupport',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = '/data/server/nginx/nginx1.7/html1/static'
...
STATICFILES_DIRS = (
    ...
    "/opt/ops-online/static/",
    #"/home/work/ops/static/",
)
...
SECRET_KEY = 'tq2*&q!qxbsro_d9g_x4*m84ban^qtwaa#(@((+(wjc)v_*oh9'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'ldapserver.context_processors.name_proc'
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "/opt/ops-online/yunwei/templates/"
)
...
#LOGIN_URL = '/root/ops/yunwei/templates/'
